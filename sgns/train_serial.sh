...
min_count=100  # 5 x 4 = 20
epch=3       # Noble et al. used 10; a much higher numer might be required to get closer for further progress
N=3          # no. of controls; Noble et al. used 10
threads=4    # default = 4 (in Python code); Noble et al. used 12

##  DOUBLE CHECK! ##
first_year=2007    # e.g. 2000 (yearly); 2003 (time_bin)
last_year=2014     # e.g. 2022 (yearly); ...
